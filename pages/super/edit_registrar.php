...
?>
            ...
            <?php 
              ...
              if (isset($_POST['edit'])) {
                  ...
                  mysqli_query($db," UPDATE tbl_admins SET admin_fname='$fname',admin_lname='$lname', email='$email', username='$username', password='$hashedPwd' WHERE admin_id = '$id' ")or die(mysql_error());
